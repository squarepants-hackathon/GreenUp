...
const Modal = ({ onClose }) => {
  ...
  const ModelURL = "https://teachablemachine.withgoogle.com/models/ongolnfw4/";
  ...
  async function capture() {
    ...
    currImage.src = imageData;
    console.log(imageData);
    console.log(currImage);
    let pred = await model.predict(currImage);
    ...
    <>
      ...
      <div className="fixed top-0 bottom-0 left-0 right-0 min-w-[400px] h-fit max-w-[500px] w-full bg-[#f5f5f5] z-[999] m-auto text-black shadow-lg rounded-lg p-4">
        ...
        >
          ...
          {/* Weight */}
          <div className="flex flex-col w-full space-y-2">
            <label htmlFor="weight" className="text-lg font-medium mt-2">
              Weight
            </label>
            <input
              name="weight"
